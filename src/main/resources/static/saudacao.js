document.addEventListener("DOMContentLoaded", function() {
    let userName = localStorage.getItem("userName"); // Recupera o nome salvo no LocalStorage

    if (userName) {
        document.getElementById("user-name").textContent = userName; // Exibe o nome no elemento <span>
    } else {
        document.getElementById("user-name").textContent = "Usuário"; // Caso não haja nome salvo, exibe "Usuário"
    }
